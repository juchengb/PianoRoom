					...
					<sp:form modelAttribute="addRoom" id="roomForm" method="post"
						...
						<div class="w-75 pt-5 pb-4 text-start mx-auto">
							...
							<div class="mb-4 row d-flex align-items-center justify-content-center">
								...
								<sp:input type="number" step="any" path="latitude" cssClass="col-10 mb-0" required="required" />
							</div>
							
							<div class="mb-4 row d-flex align-items-center justify-content-center">
								<label for="longitude" class="col-2 text-center">緯度：</label>
								<sp:input type="number" step="any" path="longitude" class="col-10 mb-0" required="required" />
							</div>			
