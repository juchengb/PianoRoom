...
//回調 Servlet 的 URI: https://localhost:8443/Groupbuy/mvc/secure/oidc/callback/google
//google 網頁應用程式 的用戶端 ID
//https://console.cloud.google.com/apis/credentials/oauthclient/

public class OIDCUtil {
	private static final String CLIENT_ID = "569672806552-pnmm51n8dre06kflkrr8am2k1pluj97j.apps.googleusercontent.com"; // 用戶端編號
	private static final String CLIENT_SECRET = "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"; // 用戶端密鑰
	private static final String REDIRECT_URI = "https://localhost:8443/Groupbuy/mvc/secure/oidc/callback/google"; // 回調的 URI
